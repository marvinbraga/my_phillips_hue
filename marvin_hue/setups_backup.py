    ...
    def __init__(self):
        super().__init__(
            ...
            settings=[
                ...
                LightSetting(
                    "Led cima", Color(152, 251, 152, 100)
                ),  # Tom de verde atualizado
            ],
        )
...
class EstimuleACriatividade(LightConfig):
    def __init__(self):
        super().__init__(
            ...
            settings=[
                LightSetting("Lâmpada 1", Color(255, 255, 204, 254)),
                LightSetting("Lâmpada 2", Color(255, 255, 204, 254)),
                LightSetting("Lâmpada 3", Color(255, 255, 204, 254)),
                LightSetting("Lâmpada 4", Color(255, 255, 204, 254)),
                LightSetting("Hue Iris", Color(255, 255, 204, 150)),
                LightSetting("Hue Play 1", Color(255, 255, 204, 200)),
                LightSetting("Hue Play 2", Color(255, 255, 204, 200)),
                LightSetting("Fita Led", Color(255, 255, 204, 60)),
                LightSetting("Led cima", Color(255, 255, 204, 60)),
            ],
        )
...
class EstimuleACriatividadeFuturista(LightConfig):
    def __init__(self):
        super().__init__(
            ...
            settings=[
                LightSetting("Lâmpada 1", Color(0, 191, 255, 254)),
                LightSetting("Lâmpada 2", Color(30, 144, 255, 254)),
                LightSetting("Lâmpada 3", Color(123, 104, 238, 254)),
                LightSetting("Lâmpada 4", Color(106, 90, 205, 254)),
                LightSetting("Hue Iris", Color(0, 191, 255, 150)),
                LightSetting("Hue Play 1", Color(30, 144, 255, 200)),
                LightSetting("Hue Play 2", Color(123, 104, 238, 200)),
                LightSetting("Fita Led", Color(106, 90, 205, 60)),
                LightSetting("Led cima", Color(0, 191, 255, 60)),
            ],
        )
    ...
    def __init__(self):
        super().__init__(
            ...
            settings=[
                ...
                LightSetting("Lâmpada 3", Color(255, 255, 204, 254)),
                LightSetting("Lâmpada 4", Color(255, 255, 204, 254)),
                LightSetting("Hue Iris", Color(204, 255, 153, 150)),
                LightSetting("Hue Play 1", Color(255, 204, 153, 150)),
...
class DiaChuvoso(LightConfig):
    def __init__(self):
        super().__init__(
            "dia_chuvoso",
            settings=[
                LightSetting("Lâmpada 1", Color(70, 130, 180, 254)),  # SteelBlue
                LightSetting("Lâmpada 2", Color(100, 149, 237, 254)),  # CornflowerBlue
                LightSetting("Lâmpada 3", Color(106, 90, 205, 254)),  # SlateBlue
                LightSetting("Lâmpada 4", Color(123, 104, 238, 254)),  # MediumSlateBlue
...
class Sextou(LightConfig):
    def __init__(self):
        super().__init__(
            "sextou",
            settings=[
                LightSetting("Lâmpada 1", Color(178, 34, 34, 254)),  # FireBrick
                LightSetting("Lâmpada 2", Color(255, 140, 0, 254)),  # DarkOrange
                LightSetting("Lâmpada 3", Color(255, 20, 147, 254)),  # DeepPink
                LightSetting("Lâmpada 4", Color(148, 0, 211, 254)),  # DarkViolet
...
class ArcoIrisAposChuva(LightConfig):
    def __init__(self):
        super().__init__(
            ...
            settings=[
                LightSetting("Lâmpada 1", Color(255, 0, 0, 254)),  # Vermelho
                LightSetting("Lâmpada 2", Color(255, 127, 0, 254)),  # Laranja
                LightSetting("Lâmpada 3", Color(255, 255, 0, 254)),  # Amarelo
                LightSetting("Lâmpada 4", Color(0, 255, 0, 254)),  # Verde
