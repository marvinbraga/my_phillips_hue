...
class LightConfigEnum(Enum):
    SETUP_BRIGHTNESS_COLORS = (
        SetupBrightnessColors,
        "Ambiente com foco em brilho e cores",
    )
    ...
    SETUP_ENTERTAINMENT = (
        SetupEntertainment,
        "Ambiente para entretenimento e diversão",
    )
    SOFT_WHITE_CONCENTRATION = (
        SoftWhiteConcentration,
        "Concentração com luz suave e branca",
    )
    ...
    AFTERNOON_DELIGHT = (
        AfternoonDelight,
        "Ambiente alegre e energético durante a tarde.",
    )
    VIDEO_LESSON_SOFT_LIGHT = (
        VideoLessonSoftLight,
        "Ambiente com luz suave e uniforme, minimizando sombras.",
    )
